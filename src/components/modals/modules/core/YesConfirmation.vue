	...
	>
		<form class="flex flex-col items-center -mt-4 w-full gap-4 " autocomplete="off" @submit.prevent="call_function()">
			...
			<div class="grid grid-cols-2 gap-4  w-full">
				...
				<button class="modal-btn" type="submit" :class="[buttonStyle]" :disabled="loading || yes_text !== 'YES'">
...
const { call_function, closeAlert, description, title, loading, type } = useYesConfirmationModal()
