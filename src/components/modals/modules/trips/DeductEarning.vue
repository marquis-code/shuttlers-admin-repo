<template>
	...
	>
		<div class="flex flex-col items-center justify-center space-y-6">
			<p class="text-sm">You are about to deduct from a Partners account</p>
			...
			<div class="field relative">
				...
				<textarea rows="6" cols="6" id="description" v-model="deductionForm.description" placeholder="Enter reason for deducton" class="input-field resize-none" required />
			</div>
		</div>
		<div class="flex justify-between items-center gap-x-6 mt-6">
			<div class="w-full"><button @click="useTripsModal().closeDeductEarning()" class="text-white bg-gray-500 w-full rounded-md py-2.5">Close</button></div>
			<div class="w-full">
