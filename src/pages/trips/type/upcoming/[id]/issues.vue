		...
		>
			<template #header>
				<TableFilter
					...
					@download="downloadUpcomingTripIssues"
				/>
			</template>
			<template #item="{ item }">
...
const { loading, issues, fetchUpcomingTripIssues, prev, page, total, next, moveTo, onFilterUpdate, downloadUpcomingTripIssues } = useUpcomingTripIssues()
