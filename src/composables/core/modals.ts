...
type CompaniesTypes = 'AssignStaff' | 'AddWorkShift' | 'AddWorkBranch' | 'AddAccountManagers'
...
const CompaniesModals = { AssignStaff, AddWorkShift, AddWorkBranch, AddAccountManagers } as Record<CompaniesTypes, any>
